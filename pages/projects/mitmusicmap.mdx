...
image: /mitmusicmap/cover-1.avif
priority: 13
...
The Z Center (athletic center) aura reflects higher energy, happier songs.
The Infinite Corridor (main hallway) aura reflects more neutral songs.
The Hayden Library (main library) aura reflects lower energy, sadder songs.
